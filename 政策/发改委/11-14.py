...
import base64
start = time.time()
url_start = "https://www.ndrc.gov.cn/xwdt/tzgg/index_14.html"
headers = {
...
for i,biaoti,faburiqis in zip(td_xpath,biaoti1,faburiqi1):
    try:
        ...
        # biaotis = biaoti3 + biaoti2 + biaoti1+biaoti4+biaoti5+biaoti6+biaoti7+biaoti8
        ...
        fujians = fujian1+fujian2+fujian3+fujian4+fujian5+fujian8+fujian7+fujian6+fujian9+fujian10+fujian12+fujian11+fujian13+fujian14+fujian15+fujian16+fujian17+fujian18
        fujianss = []
        for i in fujians:
